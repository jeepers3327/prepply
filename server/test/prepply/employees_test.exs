defmodule Prepply.EmployeesTest do
  ...
  describe "employee_profiles" do
    ...
    @update_attrs %{email: "some updated email", mobile_number: "some updated mobile_number", name: "some updated name"}
    ...
    test "create_employee_profile/1 with valid data creates a employee_profile" do
      assert {:ok, %EmployeeProfile{} = employee_profile} = Employees.create_employee_profile(@valid_attrs)
    ...
    test "update_employee_profile/2 with valid data updates the employee_profile" do
      employee_profile = employee_profile_fixture()
      assert {:ok, %EmployeeProfile{} = employee_profile} = Employees.update_employee_profile(employee_profile, @update_attrs)
    ...
    test "update_employee_profile/2 with invalid data returns error changeset" do
      employee_profile = employee_profile_fixture()
      assert {:error, %Ecto.Changeset{}} = Employees.update_employee_profile(employee_profile, @invalid_attrs)
    ...
    test "delete_employee_profile/1 deletes the employee_profile" do
      ...
      assert_raise Ecto.NoResultsError, fn -> Employees.get_employee_profile!(employee_profile.id) end
    end
  ...
  describe "employee_checklists" do
    ...
    @update_attrs %{due_date: ~D[2011-05-18], file_path: "some updated file_path", status: "some updated status"}
    ...
    test "create_employee_checklist/1 with valid data creates a employee_checklist" do
      assert {:ok, %EmployeeChecklist{} = employee_checklist} = Employees.create_employee_checklist(@valid_attrs)
    ...
    test "update_employee_checklist/2 with valid data updates the employee_checklist" do
      employee_checklist = employee_checklist_fixture()
      assert {:ok, %EmployeeChecklist{} = employee_checklist} = Employees.update_employee_checklist(employee_checklist, @update_attrs)
    ...
    test "update_employee_checklist/2 with invalid data returns error changeset" do
      employee_checklist = employee_checklist_fixture()
      assert {:error, %Ecto.Changeset{}} = Employees.update_employee_checklist(employee_checklist, @invalid_attrs)
    ...
    test "delete_employee_checklist/1 deletes the employee_checklist" do
      ...
      assert_raise Ecto.NoResultsError, fn -> Employees.get_employee_checklist!(employee_checklist.id) end
    end
